      ...
      <div className="w-full max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Partner Prospectus */}
            <div className="relative rounded-2xl overflow-hidden aspect-[3/4] cursor-pointer group bg-[#1a1a2e]">
              {/* Dark placeholder matching the handshake image in the design */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#1e1e34] to-[#2e2e4e]" />
