...
export default function WhyMBKSection() {
    ...
    useEffect(() => {
        ...
        // This is required when WhyMBKSection comes after another pinned section
        // (FeaturesSection), because the pin-spacer may not exist yet when
        // WhyMBKSection's ScrollTrigger first computes its start offset.
    ...
    return (
        <section ref={sectionRef} className="relative w-full h-screen overflow-hidden bg-white">
            ...
            <div
                ...
                className="absolute top-1/2 -translate-y-[46%] right-0 w-[58%] h-[80%] flex items-center justify-center pointer-events-none z-0 transform-gpu"
            >
                <video
            ...
            {/* Left content panel - "With MBK, customers achieve" */}
            <div
                ref={leftPanelRef}
                className="absolute top-[11%] left-8 md:left-16 w-[42%] max-w-[520px] z-10"
            >
                <h2 className="text-[1.9rem] md:text-[2.25rem] font-semibold text-[#2D1469] mb-7 leading-tight">
                    ...
                    {achievements.map((item, i) => (
                        ...
                        >
                            ...
                            <div className="px-5 pt-4 pb-4">
                                <h3 className="font-bold text-[0.95rem] text-[#2D1469] leading-snug group-hover:text-[#1A0B3B] transition-colors duration-300">
                                    {item.title}
                                </h3>
                                ...
                                >
                                    <p className="text-[0.82rem] text-gray-500 mt-2 leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
                                        {item.description}
                                    </p>
                                </div>
                            </div>
                ...
                <p
                    ref={footerRef}
                    className="mt-5 text-[1rem] md:text-[1.1rem] font-semibold text-[#2D1469] leading-snug opacity-0"
                >
                    MBK Global makes digitalisation work — not once, not in pockets, but across the entire value chain.
                </p>
            </div>

            {/* Right content panel - "Why Partners Accelerate..." */}
            <div
                ref={rightPanelRef}
                className="absolute top-[12%] right-8 md:right-16 w-[45%] max-w-[580px] z-10 opacity-0 pointer-events-none flex flex-col justify-start h-[70%]"
                style={{ opacity: 0 }}
            >
                <div className="bg-[#F5F2FC] rounded-[32px] p-8 shadow-sm pointer-events-auto relative z-20">
                    <h2 className="text-[2.2rem] md:text-[2.6rem] font-semibold text-[#3D1E85] mb-5 leading-[1.15]">
                        Why Partners Accelerate Further With MBK Global
                    </h2>
                    <p className="text-gray-600 text-[1rem] leading-relaxed mb-5 font-medium">
                    ...
                    <p className="text-[#3D1E85] text-[1.05rem] font-semibold">
            ...
            <div
                ref={phase3Ref}
                className="absolute top-[28%] right-6 md:right-[4%] lg:right-[8%] w-[41%] max-w-[460px] z-10 opacity-0 pointer-events-none flex flex-col justify-center"
                style={{ opacity: 0 }}
            >
                <h2 className="text-[1.6rem] md:text-[1.9rem] font-semibold text-[#3D1E85] mb-4 leading-[1.15]">
                    ...
                    {partnerAchievements.map((item, i) => (
                        ...
                        >
                            <div className="px-5 pt-3 pb-3">
                                <h3 className="font-bold text-[0.88rem] text-[#3D1E85] leading-snug group-hover:text-[#1A0B3B] transition-colors duration-300">
                                    {item.title}
                                </h3>
                                <div
                                    ...
                                    style={{ maxHeight: DESC_MAX_HEIGHT }}
                                >
                                    <p className="text-[0.78rem] text-gray-600 mt-1.5 leading-relaxed group-hover:text-gray-900 transition-colors duration-300 pr-2">
                                        {item.description}
                                    </p>
                                </div>
                            </div>
                ...
                <div
                    ref={phase3FooterRef}
                    className="mt-5 overflow-hidden pointer-events-auto"
                    style={{ opacity: 0, maxHeight: 0 }}
                >
                    <p className="text-[1.1rem] md:text-[1.25rem] font-semibold text-[#3D1E85] leading-snug mb-2">
            ...
            {/* Phase 4 - "The MBK Advantage" full-screen panel, rises from bottom */}
            <div
                ref={phase4Ref}
                className="absolute inset-0 z-30 bg-white flex items-center justify-between px-16 md:px-24"
                style={{ transform: "translateY(100%)", opacity: 0 }}
            >
                {/* Left: text */}
                <div className="w-[46%] max-w-[520px] flex flex-col justify-center">
                    <h2 className="text-[2rem] md:text-[2.5rem] font-bold text-[#2D1469] leading-tight mb-3">
                        The MBK Advantage:
                    </h2>
                    <h3 className="text-[1.1rem] md:text-[1.3rem] font-bold text-[#3D1E85] mb-5">
                        Orchestration at Industrial Scale
                    </h3>
                    <p className="text-gray-700 text-[0.92rem] leading-relaxed mb-3">
                    ...
                    <p className="text-gray-700 text-[0.92rem] leading-relaxed">
            ...
            >
                ...
                <div ref={phase5TopRef} className="flex flex-1 items-center px-16 md:px-24 pt-20 pb-6 gap-12">
                    {/* Left: headline */}
                    <div className="w-[38%] flex flex-col justify-center">
                        <h2 className="text-[2.8rem] md:text-[3.5rem] font-extrabold text-[#2D1469] leading-[1.1] mb-6">
                            Go Further.<br />
                            Go Faster.<br />
                            Go Together.
                        </h2>
                        <p className="text-gray-600 text-[0.95rem] leading-relaxed max-w-[420px]">
                    ...
                    <div className="flex gap-5 w-[58%]">
                        <div className="group flex-1 bg-[#EEE9F9] hover:bg-[#E4DDF7] rounded-[12px] p-7 flex flex-col justify-between min-h-[180px] relative overflow-hidden cursor-pointer transition-colors duration-300">
            ...
            <div
                ref={phase6Ref}
                className="absolute inset-0 z-40 bg-white flex items-stretch justify-center px-10 md:px-16 gap-10 overflow-hidden py-16"
                style={{ transform: "translateX(100%)", opacity: 0, paddingTop: "80px" }}
            >
                {/* Left: text + prospectus cards */}
                <div className="flex flex-col w-[38%] max-w-[420px] shrink-0 self-stretch">
                    <h2 className="text-[2.2rem] md:text-[2.7rem] font-extrabold text-[#2D1469] leading-[1.1] mb-4">
                        Let&apos;s Build the Future of Operations
                    </h2>
                    <p className="text-gray-500 text-[0.88rem] leading-relaxed mb-6">
                    ...
                    <div className="flex gap-3 flex-1">
                        ...
                        <div className="relative flex-1 rounded-2xl overflow-hidden cursor-pointer group">
                            ...
                            <span className="absolute bottom-3 left-3 text-white font-bold text-[0.85rem] z-10">Partner Prospectus</span>
                        </div>
                    </div>
                </div>

                {/* Right: form card */}
                <div className="flex-1 max-w-[620px] bg-[#EEE9F9] rounded-3xl p-7 flex flex-col gap-3 self-stretch justify-between">
                    <h3 className="text-[1.6rem] font-bold text-[#2D1469] mb-1">Work With Us</h3>
            ...
            <div ref={marqueeRef} className="absolute bottom-0 left-0 w-full z-20 bg-white pt-6 pb-2">
                <p className="text-center text-gray-600 text-[13px] font-medium mb-4">Our Partners</p>
